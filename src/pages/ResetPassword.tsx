      ...
      <main className="container mx-auto px-4 py-12 flex flex-col items-center">
        <div className="max-w-md w-full bg-white rounded-xl shadow-md p-6 space-y-6">
          <div className="flex flex-col items-center">
            ...
            <h1 className="mt-4 text-2xl font-bold text-center text-gray-800">Reset Your Password</h1>
            <p className="mt-1 text-center text-gray-600">We'll send you instructions to reset your password</p>
          </div>
          <ResetPasswordForm />
        </div>
      </main>
